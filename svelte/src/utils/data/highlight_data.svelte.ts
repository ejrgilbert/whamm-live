...
export var highlight_data: highlightData = $state({
    ...
    circles: {},
    all_wat_lines: [],
    // only applicable for wizard for navigating
    injection_start_wat_lines: [],
});
...
export function reset_highlight_data(){
    ...
    highlight_data.injection_start_wat_lines = [];
}

export function update_highlight_data(line_data: line_highlights_info, circle_data: inj_circle_highlights_info, all_wat_lines: number[], injection_start_wat_lines: number[]){
    highlight_data.lines = line_data;
    highlight_data.circles = circle_data;
    highlight_data.all_wat_lines = all_wat_lines;
    highlight_data.injection_start_wat_lines = injection_start_wat_lines;
}
