...
export namespace calculator.$ {
	...
	export namespace exports {
		export const calc = new $wcm.FunctionType<calculator.Exports['calc']>('calc',[
			['o', Operation],
		], new $wcm.ResultType<Uint32Array, calculator.ErrorCode>(new $wcm.Uint32ArrayType(), ErrorCode, Types.ErrorCode.Error_));
	}
}
export namespace calculator._ {
	...
	export type Exports = {
		'calc': (o_Operation_case: i32, o_Operation_0: i32, o_Operation_1: i32, result: ptr<result<Uint32Array, ErrorCode>>) => void;
	};
